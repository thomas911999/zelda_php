        ...
        <div class="  collapse navbar-collapse " id="navbarTogglerDemo02">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                  ...
                  <li class="nav-item">
                    ...
                    ?>
                        <li class="nav-item dropdown">
                            ...
                            <li><a class="dropdown-item" href="../utilisateur/info_user.php">Voir mon profil &nbsp;<i class="bi bi-info-square-fill"></i></a></li>
                                <li><a class="dropdown-item" href="../utilisateur/modif_user.php">Modifier mon profil &nbsp;<i class="bi bi-database-fill"></i></a></li>
                                <li><a class="dropdown-item" href="../utilisateur/deco.php">Déconnexion &nbsp;<i class="bi bi-box-arrow-right text-end"></i></a></li>
                            </ul>
                        </li>
                        <?php
                    }
                 ...
                 ?>
                  ...
                  <li class="nav-item">
                    <a class="nav-link active text-gray p-2  me-2  mt-2 fw-bold" href="topic_accueil.php">Forum</a>
                  </li>
...
<!--                   
          ...
          <form class="d-flex" role="search">
            <input class="form-control me-2" type="search" placeholder="Search" aria-label="Rechercher" name="search">

...
function modif_modal($produit)
{
    ?>
<div class="modal fade modal text-center" id=<?php echo "figure-modal$produit->IdJeux"?> tabindex="-1" aria-labelledby="Modal-figure" aria-hidden="true">
                    ...
                    <div class="modal-content">
                      <div class="modal-header text-black">
                        ...
                        <div class="modal-body CR8 w-100 p-5 pb-1">
                          <form class="fs-5 form" action=<?php echo "modif.php?change=$produit->IdJeux"?> method="POST" enctype="multipart/form-data">
                            <div class="mb-3 ">
                            ...
                            <div class="mb-3 ">
                                <label for="exampleFormControlTextarea1" class="form-label w-100">Description</label>
                                <textarea  name="description" style="width: 100%;height: 250px; font-size: 0.85rem;"> <?php echo stripslashes(htmlspecialchars($produit->Description,ENT_QUOTES));?></textarea>
                            </div>
                            <div class="d-flex justify-content-end mb-2">
                                <input type="submit" class="btn btn-mygreen w-30 me-3" name=<?php echo "$produit->IdJeux" ?>  value="Enregistrer"></input>
